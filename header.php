		...
		<header>
			<div class="wrapper">
				<div id="login">
					...
					<img id="fbPicture" class="icon" /> <span class="currentName"></span><div class="fb-login-button inline" data-scope="user_about_me, user_education_history, user_hometown, user_location, email"></div>
				</div>
